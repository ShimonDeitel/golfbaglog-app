...
final class Store: ObservableObject {
    ...
    private let fileName = "golfbaglog_items.json"
    ...
    /// Adding sub-log entries (Round Notes) is the Pro feature.
    @discardableResult
    ...
    static func seedItems() -> [Item] {
        [
        Item(name: "Driver", primaryField: "10.5 deg", secondaryField: "", notes: "New, low mileage"),
        Item(name: "7-Iron", primaryField: "34 deg", secondaryField: "", notes: "Well worn grip"),
        Item(name: "Putter", primaryField: "3 deg", secondaryField: "", notes: "Mallet head, good condition"),
        ]
    }
}
